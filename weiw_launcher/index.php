...
<html lang="zh-cmn-Hans">
	...
	<body>
		...
		<header>
			<div class="operate">
				<div class="user">
					<span id="avatar"><img src="/weiw/index_auth.php/avatar?size=48&hash={echo:[mc_user.SKIN.hash]}" /></span>
					<span id="name">{echo:[mc_user.name]}</span>
				</div>
				<div class="signIn">
					...
					<span class="money">{echo:[mc_user.bi]}</span>
					<span class="button">签到</span>
				</div>
				<div class="start" onclick="window.start({'username':'{echo:[mc_user.name]}','uuid':'{echo:[mc_user.id]}','token':'{echo:[mc_user.token]}'})">
					<span>启动游戏</span>
				</div>
			</div>
		</header>
		<main>
			<div class="menu">
				<ul>
					...
					<li if([mc_user.admin]): data-url="users.php">
					...
					<li if([mc_user.admin]): data-url="config.php">
					...
					<li if([mc_user.admin]): data-url="console.php">
