<?php class mc_user
{
     ...
     * 设置用户的披风信息
     *
     * @param string $hash 披风的哈希值，默认为空字符串
     */
    public function setCAPE($hash = '')
    {
        $this->CAPE['hash'] = $hash;
    }
     ...
     * 设置用户的皮肤信息
     *
     * @param string $hash 皮肤的哈希值，默认为 'steve'
     * @param bool $model 皮肤的模型，默认为 true，即默认模型
     */
    public function setSKIN($hash = 'steve', $model = true)
    {
        if ($model) {
            $this->SKIN['hash'] = $hash;
