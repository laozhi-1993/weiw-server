<?php defined('__MKHDIR__') or die(http_response_code(404)) ?><?php isset($this->_Unified['mc_prop']) or $this->_Unified['mc_prop'] = false ?><?php isset($this->_Unified['value']) or $this->_Unified['value'] = false ?>
<!DOCTYPE html>
	...
	<head>
		...
		<script>
			...
			function determine()
			{
				...
				{
					$.getJSON("/weiw/index.php?<?php echo token ?>",{"mods":"mc_prop_purchase","id":prop_id},function (result){
	...
	<body>
		...
		<div class="rcons">
			<table>
				...
				<?php if(is_array($this->_Unified['mc_prop']) && count($this->_Unified['mc_prop'])): ?><?php foreach($this->_Unified['mc_prop'] as $this->_Unified['value']): ?><tbody id="<?php echo $this->_Unified['value']['name'] ?>">
					<tr>
						<td><?php echo $this->_Unified['value']['name'] ?></td>
						<td><?php echo $this->_Unified['value']['price'] ?></td>
						<td><span onclick="confirm('<?php echo $this->_Unified['value']['name'] ?>','<?php echo $this->_Unified['value']['name'] ?>','<?php echo $this->_Unified['value']['price'] ?>')">购买</span></td>
					</tr>
