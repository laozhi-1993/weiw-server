			...
			<fieldset>
				...
				<div class="zong">
					<div class="zuo">
						...
						<div class="server"><span>认证地址</span><input type="text" value="<?php if(isset($this->Unified['mc_config']['config']['Yggdrasil'])): ?><?php echo $this->Unified['mc_config']['config']['Yggdrasil'] ?><?php endif; ?>" id="Yggdrasil" /></div>
					</div>
					<div class="you">
