...
<html lang="zh-cmn-Hans">
	...
	<body>
		...
		<main>
			<?php if((isset($this->Unified['mc_user'])) && ($this->Unified['mc_user'] == false)): ?><div class="login">
				<div id="Default">
			...
			</div><?php else: ?><div class="login_auto">
				<div class="avatar">
					<img src="/weiw/index_auth.php/avatar?size=240&hash=<?php if(isset($this->Unified['mc_user']['SKIN']['hash'])): ?><?php echo $this->Unified['mc_user']['SKIN']['hash'] ?><?php endif; ?>" />
				</div>
