...
<html lang="zh-cmn-Hans">
	<head>
		...
		<script>
			window.addEventListener('DOMContentLoaded', function() {
				...
				tabFrame.addEventListener('load', function() {
					var tabDocument = tabFrame.contentDocument || tabFrame.contentWindow.document;
					...
					var links = tabDocument.querySelectorAll("a:not([href^='javascript:'])");
					...
					var headElement = tabDocument.querySelector("head");
					headElement.insertAdjacentHTML('afterbegin', scrollbarStyle);

					tabFrame.style.display = 'block';
					tabLoading.style.display = 'none';
				});

				var menuItems = document.querySelectorAll("main .menu ul li[data-url]");
				menuItems.forEach(function(item) {
					item.addEventListener('click', function() {
						...
						tabFrame.setAttribute("src", item.dataset.url);
						tabFrame.style.display = 'none';
						tabLoading.style.display = 'block';
					});
				});
	...
	<body>
		...
		<header>
			<div class="operate">
				<div class="user">
					<span id="avatar"><img src="/weiw/index_auth.php/avatar?size=48&hash=<?php if(isset($this->Unified['mc_user']['SKIN']['hash'])): ?><?php echo $this->Unified['mc_user']['SKIN']['hash'] ?><?php endif; ?>" /></span>
