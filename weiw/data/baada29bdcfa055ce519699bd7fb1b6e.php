...
<html lang="zh-cmn-Hans">
	...
	<body>
		...
		<header>
			<div class="operate">
				<div class="user">
					<span id="avatar"><img src="/weiw/index_auth.php/avatar/<?php if(isset($this->Unified['mc_user']['SKIN']['hash'])): ?><?php echo $this->Unified['mc_user']['SKIN']['hash'] ?><?php endif; ?>/48" /></span>
					<span id="name"><?php if(isset($this->Unified['mc_user']['name'])): ?><?php echo $this->Unified['mc_user']['name'] ?><?php endif; ?></span>
				</div>
				<div class="checkin">
					...
					<span class="money"><?php if(isset($this->Unified['mc_user']['money'])): ?><?php echo $this->Unified['mc_user']['money'] ?><?php endif; ?></span>
					<span class="button">签到</span>
				</div>
				<div class="start" onclick="window.start({'username':'<?php if(isset($this->Unified['mc_user']['name'])): ?><?php echo $this->Unified['mc_user']['name'] ?><?php endif; ?>','uuid':'<?php if(isset($this->Unified['mc_user']['uuid'])): ?><?php echo $this->Unified['mc_user']['uuid'] ?><?php endif; ?>','token':'<?php if(isset($this->Unified['mc_user']['accessToken'])): ?><?php echo $this->Unified['mc_user']['accessToken'] ?><?php endif; ?>'})">
					<span>启动游戏</span>
				</div>
			</div>
		</header>
		<main>
			<div class="menu">
				<ul>
					...
					<li data-url="textures.php?filter=cape">
						<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3396"><path d="M512 64a128 128 0 0 1 84.672 224h54.336a128 128 0 0 1 117.952 78.336L992 896l-162.88-46.528a128 128 0 0 0-112 20.672L588.8 966.4a128 128 0 0 1-153.6 0l-128.32-96.256a128 128 0 0 0-112-20.672L32 896l223.04-529.664A128 128 0 0 1 372.992 288h54.336A128 128 0 0 1 512 64z" fill="#040404" p-id="3397"></path></svg>
					</li>
					<?php if((isset($this->Unified['mc_user']['admin'])) && ($this->Unified['mc_user']['admin'] == true)): ?><li data-url="users.php">
					...
					<?php if((isset($this->Unified['mc_user']['admin'])) && ($this->Unified['mc_user']['admin'] == true)): ?><li data-url="config.php?<?php echo token ?>">
				...
				<div class="LogOut">
					<a href="javascript:window.location.replace('login.php');document.cookie = 'login_token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;';">
						<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="17620"><path d="M800 108.2c126 90 208 237.2 208 403.8 0 273.6-221.6 495.4-495 496C240 1008.6 16.4 786 16 512.8 15.8 346.2 97.8 198.6 223.6 108.4c23.4-16.6 56-9.6 70 15.4L325.2 180c11.8 21 6.2 47.6-13.2 62-83 61.6-136 159.2-136 269.8-0.2 184.6 149 336.2 336 336.2 183.2 0 337.2-148.4 336-338.2-0.6-103.6-49.4-203.6-136.2-268-19.4-14.4-24.8-41-13-61.8l31.6-56.2c14-24.8 46.4-32.2 69.6-15.6zM592 528V48c0-26.6-21.4-48-48-48h-64c-26.6 0-48 21.4-48 48v480c0 26.6 21.4 48 48 48h64c26.6 0 48-21.4 48-48z" p-id="17621"></path></svg>
					</a>
				</div>
			</div>
			<div class="content">
