<?php defined('__MKHDIR__') or die(http_response_code(404)) ?><?php isset($this->_Unified['mc_user']['id']) or $this->_Unified['mc_user']['id'] = false ?>
<!DOCTYPE html>
<html lang="zh-cmn-Hans">
	...
	<body>
		...
		<main>
			<?php if(!$this->_Unified['mc_user']['id']): ?><div class="login">
				<h1>登录</h1>
			...
			<?php if( $this->_Unified['mc_user']['id']): ?><div class="login_auto">
				<div class="avatar">
					<img src="/weiw/index_auth.php/avatar?size=180&hash=<?php echo $this->_Unified['mc_user']['SKIN']['hash'] ?>" />
				</div>
				<div class="name"><?php echo $this->_Unified['mc_user']['name'] ?></div>
