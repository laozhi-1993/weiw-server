...
<html lang="zh-cmn-Hans">
	<head>
		...
		<title><?php if(isset($this->Unified['config']['serverName'])): ?><?php echo $this->Unified['config']['serverName'] ?><?php endif; ?></title>
	</head>
	<body>
		<header>
			<div class="position">
				<div class="zuo">
					<span id="test"><?php if(isset($this->Unified['config']['domain'])): ?><?php echo $this->Unified['config']['domain'] ?><?php endif; ?></span>
				</div>
				<div class="you">
					<a href="<?php if(isset($this->Unified['config']['download'])): ?><?php echo $this->Unified['config']['download'] ?><?php endif; ?>">
		...
		<main>
			<div class="download">
				<div class="txt"><span>欢迎来到 <?php if(isset($this->Unified['config']['serverName'])): ?><?php echo $this->Unified['config']['serverName'] ?><?php endif; ?> 官方网站</span></div>
				<div class="icon"><img src="favicon.ico" /></div>
				<div class="link"><a href="<?php if(isset($this->Unified['config']['download'])): ?><?php echo $this->Unified['config']['download'] ?><?php endif; ?>"><svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M828.975746 894.125047 190.189132 894.125047c-70.550823 0-127.753639-57.18542-127.753639-127.752616L62.435493 606.674243c0-17.634636 14.308891-31.933293 31.93227-31.933293l63.889099 0c17.634636 0 31.93227 14.298658 31.93227 31.933293l0 95.821369c0 35.282574 28.596292 63.877843 63.87682 63.877843L765.098927 766.373455c35.281551 0 63.87682-28.595268 63.87682-63.877843l0-95.821369c0-17.634636 14.298658-31.933293 31.943526-31.933293l63.877843 0c17.634636 0 31.933293 14.298658 31.933293 31.933293l0 159.699212C956.729385 836.939627 899.538849 894.125047 828.975746 894.125047L828.975746 894.125047zM249.938957 267.509636c12.921287-12.919241 33.884738-12.919241 46.807049 0l148.97087 148.971893L445.716876 94.89323c0-17.634636 14.300704-31.94762 31.933293-31.94762l63.875796 0c17.637706 0 31.945573 14.312984 31.945573 31.94762l0 321.588299 148.97087-148.971893c12.921287-12.919241 33.875528-12.919241 46.796816 0l46.814212 46.818305c12.921287 12.922311 12.921287 33.874505 0 46.807049L552.261471 624.930025c-1.140986 1.137916-21.664416 13.68365-42.315758 13.69286-20.87647 0.010233-41.878806-12.541641-43.020816-13.69286L203.121676 361.13499c-12.922311-12.933567-12.922311-33.884738 0-46.807049L249.938957 267.509636 249.938957 267.509636z"></path></svg> <span>下载客户端</span></a></div>
			</div>
			<div class="introduce">
				<div class="image">
					<img src="/images/0Oi06.jpg" />
				</div>
			</div>
		</main>
		<footer>
			...
			<div class="statement">
				<span>Copyright © <?php if(isset($this->Unified['config']['serverName'])): ?><?php echo $this->Unified['config']['serverName'] ?><?php endif; ?> 2023</span>
			</div>
		</footer>
	</body>
</html>