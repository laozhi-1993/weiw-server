...
<html lang="zh-cmn-Hans">
	<head>
		...
		<title>{echo:[config.serverName]}</title>
	</head>
	<body>
		<header>
			<div class="position">
				<div class="zuo">
					<span>{echo:[config.domain]}</span>
				</div>
				<div class="you">
					<a href="{echo:[config.download]}">
		...
		<footer>
			...
			<div class="statement">
				<span>Copyright © {echo:[config.serverName]} 2023</span>
			</div>
		</footer>
	</body>
</html>