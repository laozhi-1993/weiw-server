...
<html lang="zh-CN">
	...
	<body>
		<section>
			...
			<main>
				<loading-container id="cardContainer">
					<div foreach(var.mc_skin_list.data,var.key,var.value) class="texture-item">
		...
		<script>
			...
			function loading() {
				fetch(`skins.php?findId=cardContainer&page=${count}`)
			...
			{
				fetch(`/weiw/index.php?mods=mc_skin&id=${id}`, {
					method: 'GET',
				})
